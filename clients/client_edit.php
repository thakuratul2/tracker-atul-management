...
<html lang="en">
  ...
  <body>
          ...
          <div class="content-wrapper">
            <div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Clients > Edit Clients</h4>
                    <form class="forms-sample" id="userForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Client Name" value="<?php echo $name; ?>" name="name" required>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername1">Client UserName</label>
                            <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Client Username" value="<?php echo $username ?>" name="username" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="exampleInputSalary" placeholder="Mobile" name="mobile" value="<?php echo $mobile ?>"  required>
                        </div>
    ...
    $('#userForm').submit(function(e) {
        ...
        $.ajax({
            url: '../method/client_method.php?id=<?php echo $id; ?>',
            type: 'POST',
            data: formData,
            success: function(response) {
                if (response == 'Success') {
                    ...
                    $('#responseMessage').text('Client Updated Successfully').css('color', 'green');
                } else {
