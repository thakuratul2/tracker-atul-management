                  ...
                  <table class="table table-hover">
                    <thead>
                      <tr>
                        ...
                        <th>Task Time</th>
                        <th>Consumed Time</th>
                        <th class="<?php echo empty($task['performance']) ? 'hidden' : ''; ?>">Performance</th>
                        <th>Project Name</th>
                        <th>Task Type</th>
                        <th>Task Timer</th>
                        <th>Action</th>
                      ...
                      if (mysqli_num_rows($row) > 0) {
                        ...
                        while ($task = mysqli_fetch_assoc($row)) {
                          ...
                          <tr>
                            ...
                            <td><?php echo $task['task_type']; ?></td>
                            <td>
                              <i class="fa-regular fa-clock clock-icon-timer" data-task-id="<?php echo $task['t_id']; ?>"
                                style="margin-left:15px; cursor: pointer;"></i>
                              <span class="stopwatch-timer" id="timer-<?php echo $task['t_id']; ?>"
                                style="margin-left:10px;"></span>
                            </td>
                            <td>
                              <a href="delete_task.php?t_id=<?php echo $task['t_id']; ?>"
